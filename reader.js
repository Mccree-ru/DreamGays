const reader = {
    ...
    initTouchGestures() {
        ...
        // ИСПРАВЛЕНО: Убрано { passive: true } для предотвращения сбоев системного зума Telegram Web App
        ...
        track.addEventListener('touchmove', (e) => {
            ...
            if (e.touches.length === 1 && this.isDragging) {
                ...
                // ИСПРАВЛЕНО: Лимиты рассчитываются от физического контейнера картинки, а не от окна браузера
    ...
    async sendPageComment() {
        if (this.isSendingComment) return; // ИСПРАВЛЕНО: Блокировка флуда/мультикликов
