const contextMenuManager = {
	...
	init() {
        ...
        // НАМЕРТВО БЛОКИРУЕТ ВСТРОЕННОЕ МЕНЮ (И на ПК, и на смартфонах)
        catalogContainer.addEventListener('contextmenu', (e) => {
            e.preventDefault(); // Запрещаем родное меню браузера
            this.handleContextMenu(e); // Вызываем наше кастомное
        });

        // Закрытие нашего меню при клике мимо
